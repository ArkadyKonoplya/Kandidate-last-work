    ...
    <!-- END: Left Aside -->
        <div class="m-grid__item m-grid__item--fluid m-wrapper">
                ...
                <div class="d-flex align-items-center">
                    <div class="mr-auto">
                        <h3 class="m-page-title ">
                            <a href="{{ url('/admin/kandidaten')}}">Send Invite Festanstellung</a>
                        </h3>
                    </div>
                </div>
            </div>
            ...
            <div class="m-portlet m-portlet--rounded view_block">
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" method="post" action="{{route('candidate.sendInvite')}}"
                            ...
                            <div class="form-group m-form__group {{ $errors->has('email') ? ' has-error' : '' }}" >
                                ...
                                <div class="col-lg-6">
                                    <input type="email" name="email" id="email" class="form-control m-input"
                                           placeholder="Enter Client email" required autofocus>
                                    @if ($errors->has('email'))
